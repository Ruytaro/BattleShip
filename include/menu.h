...
typedef struct menu {
  ...
  void (*callbacks[10])(
      game_t *); // Array of function pointers for option callbacks
...
void menu_insert_option(menu_t *, u8, const char *option,
                        void (*callback)(game_t *));
void menu_update_option(menu_t *, uint8_t index, const char *new_option,
                        void (*callback)(game_t *));
